 ...
 */
        ...
        #ifndef PRF_LOGOFFTYPE_H
        #define PRF_LOGOFFTYPE_H
        ...
        */
        ...
        typedef struct prf_logOffType prf_logOffType_t;
        ...
        /**
         * Constructor for creating prf_logOffType_t
         * @param env pointer to environment struct
         * @return newly created prf_logOffType_t object
         */
         ...
         * @param  _logOffType prf_logOffType_t object to free
         * @param env pointer to environment struct
         ...
         * @param  _logOffType prf_logOffType_t object
         * @param env pointer to environment struct
       ...
       prf_logOffType_declare_parent_namespaces(
         ...
         * @param  _logOffType prf_logOffType_t object
         * @param env pointer to environment struct
         * @param logOffType_om_node node to serialize from
         * @param logOffType_om_element parent element to serialize from
        ...
        prf_logOffType_serialize(
            prf_logOffType_t* _logOffType,
            const axutil_env_t *env,
            axiom_node_t* logOffType_om_node, axiom_element_t *logOffType_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the prf_logOffType is a particle class (E.g. group, inner sequence)
        ...
        prf_logOffType_create_with_values(
            const axutil_env_t *env);
                ...
                /**
                 * Free prf_logOffType_t object and return the property value.
