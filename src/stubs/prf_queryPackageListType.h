 ...
 */
        ...
        #ifndef PRF_QUERYPACKAGELISTTYPE_H
        #define PRF_QUERYPACKAGELISTTYPE_H
       ...
       /**
        *  prf_queryPackageListType class
        */
        ...
        typedef struct prf_queryPackageListType prf_queryPackageListType_t;
        ...
        /**
         * Constructor for creating prf_queryPackageListType_t
         * @param env pointer to environment struct
         * @return newly created prf_queryPackageListType_t object
         */
         ...
         * @param  _queryPackageListType prf_queryPackageListType_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free prf_queryPackageListType_t object
         * @param  _queryPackageListType prf_queryPackageListType_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _queryPackageListType prf_queryPackageListType_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
         ...
         * @param  _queryPackageListType prf_queryPackageListType_t object
         * @param env pointer to environment struct
         * @param arg_firmwareType axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
         ...
         * @param  _queryPackageListType prf_queryPackageListType_t object
         * @param env pointer to environment struct
         * @param arg_firmwareVersion axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       prf_queryPackageListType_declare_parent_namespaces(
         ...
         * @param  _queryPackageListType prf_queryPackageListType_t object
         * @param env pointer to environment struct
         * @param queryPackageListType_om_node node to serialize from
         * @param queryPackageListType_om_element parent element to serialize from
        ...
        prf_queryPackageListType_serialize(
            prf_queryPackageListType_t* _queryPackageListType,
            const axutil_env_t *env,
            axiom_node_t* queryPackageListType_om_node, axiom_element_t *queryPackageListType_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the prf_queryPackageListType is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating prf_queryPackageListType_t
         * @param env pointer to environment struct
         * @param _firmwareType axis2_char_t*
         * @param _firmwareVersion axis2_char_t*
         * @return newly created prf_queryPackageListType_t object
         */
        prf_queryPackageListType_t* AXIS2_CALL
        prf_queryPackageListType_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free prf_queryPackageListType_t object and return the property value.
     ...
     #endif /* PRF_QUERYPACKAGELISTTYPE_H */
