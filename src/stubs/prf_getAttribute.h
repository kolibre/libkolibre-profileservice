 ...
 */
        ...
        #ifndef PRF_GETATTRIBUTE_H
        #define PRF_GETATTRIBUTE_H
        ...
        */
        ...
        typedef struct prf_getAttribute prf_getAttribute_t;
        ...
        /**
         * Constructor for creating prf_getAttribute_t
         * @param env pointer to environment struct
         * @return newly created prf_getAttribute_t object
         */
         ...
         * @param  _getAttribute prf_getAttribute_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free prf_getAttribute_t object
         * @param  _getAttribute prf_getAttribute_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _getAttribute prf_getAttribute_t object
         * @param env pointer to environment struct
         * @return prf_getAttributeType_t*
         */
         ...
         * @param  _getAttribute prf_getAttribute_t object
         * @param env pointer to environment struct
         * @param arg_getAttribute prf_getAttributeType_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       prf_getAttribute_declare_parent_namespaces(
         ...
         * @param  _getAttribute prf_getAttribute_t object
         * @param env pointer to environment struct
         * @param getAttribute_om_node node to serialize from
         * @param getAttribute_om_element parent element to serialize from
        ...
        prf_getAttribute_serialize(
            prf_getAttribute_t* _getAttribute,
            const axutil_env_t *env,
            axiom_node_t* getAttribute_om_node, axiom_element_t *getAttribute_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the prf_getAttribute is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating prf_getAttribute_t
         * @param env pointer to environment struct
         * @param _getAttribute prf_getAttributeType_t*
         * @return newly created prf_getAttribute_t object
         */
        prf_getAttribute_t* AXIS2_CALL
        prf_getAttribute_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free prf_getAttribute_t object and return the property value.
