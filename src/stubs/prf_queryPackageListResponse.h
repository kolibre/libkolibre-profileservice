 ...
 */
        ...
        #ifndef PRF_QUERYPACKAGELISTRESPONSE_H
        #define PRF_QUERYPACKAGELISTRESPONSE_H
       ...
       /**
        *  prf_queryPackageListResponse class
        */
        ...
        typedef struct prf_queryPackageListResponse prf_queryPackageListResponse_t;
        ...
        /**
         * Constructor for creating prf_queryPackageListResponse_t
         * @param env pointer to environment struct
         * @return newly created prf_queryPackageListResponse_t object
         */
         ...
         * @param  _queryPackageListResponse prf_queryPackageListResponse_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free prf_queryPackageListResponse_t object
         * @param  _queryPackageListResponse prf_queryPackageListResponse_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _queryPackageListResponse prf_queryPackageListResponse_t object
         * @param env pointer to environment struct
         * @return prf_queryPackageListResponseType_t*
         */
         ...
         * @param  _queryPackageListResponse prf_queryPackageListResponse_t object
         * @param env pointer to environment struct
         * @param arg_queryPackageListResponse prf_queryPackageListResponseType_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       prf_queryPackageListResponse_declare_parent_namespaces(
         ...
         * @param  _queryPackageListResponse prf_queryPackageListResponse_t object
         * @param env pointer to environment struct
         * @param queryPackageListResponse_om_node node to serialize from
         * @param queryPackageListResponse_om_element parent element to serialize from
        ...
        prf_queryPackageListResponse_serialize(
            prf_queryPackageListResponse_t* _queryPackageListResponse,
            const axutil_env_t *env,
            axiom_node_t* queryPackageListResponse_om_node, axiom_element_t *queryPackageListResponse_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the prf_queryPackageListResponse is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating prf_queryPackageListResponse_t
         * @param env pointer to environment struct
         * @param _queryPackageListResponse prf_queryPackageListResponseType_t*
         * @return newly created prf_queryPackageListResponse_t object
         */
        prf_queryPackageListResponse_t* AXIS2_CALL
        prf_queryPackageListResponse_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free prf_queryPackageListResponse_t object and return the property value.
     ...
     #endif /* PRF_QUERYPACKAGELISTRESPONSE_H */
