 ...
 */
        ...
        */
        ...
        typedef struct prf_logOff prf_logOff_t;
        ...
        /**
         * Constructor for creating prf_logOff_t
         * @param env pointer to environment struct
         * @return newly created prf_logOff_t object
         */
         ...
         * @param  _logOff prf_logOff_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Getter for logOff. 
         * @param  _logOff prf_logOff_t object
         * @param env pointer to environment struct
         * @return prf_logOffType_t*
         */
         ...
         * @param  _logOff prf_logOff_t object
         * @param env pointer to environment struct
         * @param arg_logOff prf_logOffType_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       prf_logOff_declare_parent_namespaces(
        ...
        /**
         * Check whether the prf_logOff is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating prf_logOff_t
         * @param env pointer to environment struct
         * @param _logOff prf_logOffType_t*
         * @return newly created prf_logOff_t object
         */
        prf_logOff_t* AXIS2_CALL
        prf_logOff_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free prf_logOff_t object and return the property value.
