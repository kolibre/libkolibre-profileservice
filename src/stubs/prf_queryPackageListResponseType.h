 ...
 */
        ...
        #ifndef PRF_QUERYPACKAGELISTRESPONSETYPE_H
        #define PRF_QUERYPACKAGELISTRESPONSETYPE_H
       ...
       /**
        *  prf_queryPackageListResponseType class
        */
        ...
        typedef struct prf_queryPackageListResponseType prf_queryPackageListResponseType_t;
        ...
        /**
         * Constructor for creating prf_queryPackageListResponseType_t
         * @param env pointer to environment struct
         * @return newly created prf_queryPackageListResponseType_t object
         */
         ...
         * @param  _queryPackageListResponseType prf_queryPackageListResponseType_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free prf_queryPackageListResponseType_t object
         * @param  _queryPackageListResponseType prf_queryPackageListResponseType_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _queryPackageListResponseType prf_queryPackageListResponseType_t object
         * @param env pointer to environment struct
         ...
         * @param  _queryPackageListResponseType prf_queryPackageListResponseType_t object
         * @param env pointer to environment struct
         * @param arg_packageListResult prf_packageListType_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       prf_queryPackageListResponseType_declare_parent_namespaces(
         ...
         * @param  _queryPackageListResponseType prf_queryPackageListResponseType_t object
         * @param env pointer to environment struct
         * @param queryPackageListResponseType_om_node node to serialize from
         * @param queryPackageListResponseType_om_element parent element to serialize from
        ...
        prf_queryPackageListResponseType_serialize(
            prf_queryPackageListResponseType_t* _queryPackageListResponseType,
            const axutil_env_t *env,
            axiom_node_t* queryPackageListResponseType_om_node, axiom_element_t *queryPackageListResponseType_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the prf_queryPackageListResponseType is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating prf_queryPackageListResponseType_t
         * @param env pointer to environment struct
         * @param _packageListResult prf_packageListType_t*
         * @return newly created prf_queryPackageListResponseType_t object
         */
        prf_queryPackageListResponseType_t* AXIS2_CALL
        prf_queryPackageListResponseType_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free prf_queryPackageListResponseType_t object and return the property value.
     ...
     #endif /* PRF_QUERYPACKAGELISTRESPONSETYPE_H */
