 ...
 */
        ...
        #ifndef PRF_SETATTRIBUTE_H
        #define PRF_SETATTRIBUTE_H
        ...
        */
        ...
        typedef struct prf_setAttribute prf_setAttribute_t;
        ...
        /**
         * Constructor for creating prf_setAttribute_t
         * @param env pointer to environment struct
         * @return newly created prf_setAttribute_t object
         */
         ...
         * @param  _setAttribute prf_setAttribute_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free prf_setAttribute_t object
         * @param  _setAttribute prf_setAttribute_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _setAttribute prf_setAttribute_t object
         * @param env pointer to environment struct
         * @return prf_setAttributeType_t*
         */
         ...
         * @param  _setAttribute prf_setAttribute_t object
         * @param env pointer to environment struct
         * @param arg_setAttribute prf_setAttributeType_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       prf_setAttribute_declare_parent_namespaces(
         ...
         * @param  _setAttribute prf_setAttribute_t object
         * @param env pointer to environment struct
         * @param setAttribute_om_node node to serialize from
         * @param setAttribute_om_element parent element to serialize from
        ...
        prf_setAttribute_serialize(
            prf_setAttribute_t* _setAttribute,
            const axutil_env_t *env,
            axiom_node_t* setAttribute_om_node, axiom_element_t *setAttribute_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the prf_setAttribute is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating prf_setAttribute_t
         * @param env pointer to environment struct
         * @param _setAttribute prf_setAttributeType_t*
         * @return newly created prf_setAttribute_t object
         */
        prf_setAttribute_t* AXIS2_CALL
        prf_setAttribute_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free prf_setAttribute_t object and return the property value.
