 ...
 */
        ...
        #ifndef PRF_GETATTRIBUTERESPONSETYPE_H
        #define PRF_GETATTRIBUTERESPONSETYPE_H
       ...
       /**
        *  prf_getAttributeResponseType class
        */
        ...
        typedef struct prf_getAttributeResponseType prf_getAttributeResponseType_t;
        ...
        /**
         * Constructor for creating prf_getAttributeResponseType_t
         * @param env pointer to environment struct
         * @return newly created prf_getAttributeResponseType_t object
         */
         ...
         * @param  _getAttributeResponseType prf_getAttributeResponseType_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free prf_getAttributeResponseType_t object
         * @param  _getAttributeResponseType prf_getAttributeResponseType_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _getAttributeResponseType prf_getAttributeResponseType_t object
         * @param env pointer to environment struct
         * @return axis2_char_t*
         */
         ...
         * @param  _getAttributeResponseType prf_getAttributeResponseType_t object
         * @param env pointer to environment struct
         * @param arg_getAttributeResult axis2_char_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       prf_getAttributeResponseType_declare_parent_namespaces(
         ...
         * @param  _getAttributeResponseType prf_getAttributeResponseType_t object
         * @param env pointer to environment struct
         * @param getAttributeResponseType_om_node node to serialize from
         * @param getAttributeResponseType_om_element parent element to serialize from
        ...
        prf_getAttributeResponseType_serialize(
            prf_getAttributeResponseType_t* _getAttributeResponseType,
            const axutil_env_t *env,
            axiom_node_t* getAttributeResponseType_om_node, axiom_element_t *getAttributeResponseType_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the prf_getAttributeResponseType is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating prf_getAttributeResponseType_t
         * @param env pointer to environment struct
         * @param _getAttributeResult axis2_char_t*
         * @return newly created prf_getAttributeResponseType_t object
         */
        prf_getAttributeResponseType_t* AXIS2_CALL
        prf_getAttributeResponseType_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free prf_getAttributeResponseType_t object and return the property value.
     ...
     #endif /* PRF_GETATTRIBUTERESPONSETYPE_H */
