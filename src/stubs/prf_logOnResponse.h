 ...
 */
        ...
        #ifndef PRF_LOGONRESPONSE_H
        #define PRF_LOGONRESPONSE_H
        ...
        */
        ...
        typedef struct prf_logOnResponse prf_logOnResponse_t;
        ...
        /**
         * Constructor for creating prf_logOnResponse_t
         * @param env pointer to environment struct
         * @return newly created prf_logOnResponse_t object
         */
         ...
         * @param  _logOnResponse prf_logOnResponse_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free prf_logOnResponse_t object
         * @param  _logOnResponse prf_logOnResponse_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _logOnResponse prf_logOnResponse_t object
         * @param env pointer to environment struct
         * @return prf_logOnResponseType_t*
         */
         ...
         * @param  _logOnResponse prf_logOnResponse_t object
         * @param env pointer to environment struct
         * @param arg_logOnResponse prf_logOnResponseType_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       prf_logOnResponse_declare_parent_namespaces(
        ...
        /**
         * Check whether the prf_logOnResponse is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating prf_logOnResponse_t
         * @param env pointer to environment struct
         * @param _logOnResponse prf_logOnResponseType_t*
         * @return newly created prf_logOnResponse_t object
         */
        prf_logOnResponse_t* AXIS2_CALL
        prf_logOnResponse_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free prf_logOnResponse_t object and return the property value.
