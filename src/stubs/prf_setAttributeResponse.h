 ...
 */
        ...
        #ifndef PRF_SETATTRIBUTERESPONSE_H
        #define PRF_SETATTRIBUTERESPONSE_H
       ...
       /**
        *  prf_setAttributeResponse class
        */
        ...
        typedef struct prf_setAttributeResponse prf_setAttributeResponse_t;
        ...
        /**
         * Constructor for creating prf_setAttributeResponse_t
         * @param env pointer to environment struct
         * @return newly created prf_setAttributeResponse_t object
         */
         ...
         * @param  _setAttributeResponse prf_setAttributeResponse_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Free prf_setAttributeResponse_t object
         * @param  _setAttributeResponse prf_setAttributeResponse_t object to free
         * @param env pointer to environment struct
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
         ...
         * @param  _setAttributeResponse prf_setAttributeResponse_t object
         * @param env pointer to environment struct
         * @return prf_setAttributeResultType_t*
         */
         ...
         * @param  _setAttributeResponse prf_setAttributeResponse_t object
         * @param env pointer to environment struct
         * @param arg_setAttributeResponse prf_setAttributeResultType_t*
         * @return AXIS2_SUCCESS on success, else AXIS2_FAILURE
         */
        axis2_status_t AXIS2_CALL
       ...
       prf_setAttributeResponse_declare_parent_namespaces(
         ...
         * @param  _setAttributeResponse prf_setAttributeResponse_t object
         * @param env pointer to environment struct
         * @param setAttributeResponse_om_node node to serialize from
         * @param setAttributeResponse_om_element parent element to serialize from
        ...
        prf_setAttributeResponse_serialize(
            prf_setAttributeResponse_t* _setAttributeResponse,
            const axutil_env_t *env,
            axiom_node_t* setAttributeResponse_om_node, axiom_element_t *setAttributeResponse_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the prf_setAttributeResponse is a particle class (E.g. group, inner sequence)
         ...
         * Constructor for creating prf_setAttributeResponse_t
         * @param env pointer to environment struct
         * @param _setAttributeResponse prf_setAttributeResultType_t*
         * @return newly created prf_setAttributeResponse_t object
         */
        prf_setAttributeResponse_t* AXIS2_CALL
        prf_setAttributeResponse_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free prf_setAttributeResponse_t object and return the property value.
     ...
     #endif /* PRF_SETATTRIBUTERESPONSE_H */
